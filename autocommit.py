...
def make_change_and_commit(repo_path, file_path, commit_message):
    ...
    with open(file_path, 'a') as file:
        file.write('_') # Appending a dot to the file
...
if __name__ == "__main__":
    while True:
        ...
        print("Commit made. Waiting 4 seconds for the next commit.")
        time.sleep(4)  # Wait for 10 seconds before the next iteration
